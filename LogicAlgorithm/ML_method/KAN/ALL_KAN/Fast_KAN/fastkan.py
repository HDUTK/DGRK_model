...
# -*- coding: utf-8 -*-
"""
function description: 此文件是Github上ZiyaoLi于202405日版本的fast-kan项目
Used Gaussian Radial Basis Functions to approximate the B-spline basis,
which is the bottleneck of KAN and efficient KAN
用RBF高斯（Gaussian）径向基函数逼近B样条基
author: ZiyaoLi
contact: https://github.com/ZiyaoLi/fast-kan
IDE: PyCharm Community Edition 2020.2.5
time: 2024/6/19 10:09
version: V1.0
"""
