...
# -*- coding: utf-8 -*-
"""
function description: 此文件是Github上hoangthangta于202405日版本的ThangKAN项目
author: hoangthangta
contact: https://github.com/hoangthangta/ThangKAN
IDE: PyCharm Community Edition 2020.2.5
time: 2024/6/21 10:09
version: V1.0
"""
...
class FasterKANLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        spline_basis = self.rbf(x).view(*(self.rbf(x)).shape[:-2], -1)
