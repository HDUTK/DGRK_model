...
class KAC_Net(nn.Module):  # Kolmogorov Arnold chebyshev Network (KAC-Net)
    ...
    def forward(self, x):
        ...
        for i, (base_weight, poly_weight, layer_norm) in enumerate(
            ...
            chebyshev_basis = chebyshev_basis.view(*chebyshev_basis.shape[:-2], -1)
